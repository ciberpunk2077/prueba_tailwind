...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i in range(500):
            try:
                ...
                # Crear imagen simulada (archivo de texto como placeholder)
    ...
    def create_placeholder_image(self, muestra):
        ...
        try:
            ...
            filename = f"helecho_{muestra.numero_recolecta}.txt"
            ...
            with open(filepath, 'w', encoding='utf-8') as f:
                ...
                f.write("Esta es una imagen simulada para representar el helecho recolectado.")
