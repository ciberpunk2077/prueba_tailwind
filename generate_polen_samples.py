#!/usr/bin/env python
"""
Script para generar 300 muestras de polen nativas de Villahermosa, Tabasco
Ejecutar con: python manage.py shell < generate_polen_samples.py
"""
...
def create_fake_image(nombre_especie):
    ...
    # Crear una imagen simple con el nombre de la especie
    img = Image.new('RGB', (800, 600), color=(random.randint(200, 255), random.randint(200, 255), random.randint(200, 255)))
